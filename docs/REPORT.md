...
> Update: The latest exhaustive V3 report is available at `docs/REPORT_V3_TWO_TOWER_HYBRID.md`.
> V2 report remains available at `docs/REPORT_V2_ARCHITECTURE_AND_SCALING.md`.
